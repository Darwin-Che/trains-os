...
// void k_mbox_send_init(struct kMailbox *mbox, const char *msg, size_t msglen, char *reply, size_t rplen);
// void k_mbox_recv_init(struct kMailbox *mbox, char *msg, size_t msglen, int *tid);
...
static inline void k_mbox_send_init(struct kMailbox *mbox, const char *msg, size_t msglen, char *reply, size_t rplen)
{
  mbox->out_msg = msg;
...
static inline void k_mbox_recv_init(struct kMailbox *mbox, char *msg, size_t msglen, int *tid)
{
  mbox->in_buf = msg;
...
static inline void k_mbox_add_send_queue(struct kMailbox *mbox, struct kTaskDsp *sender)
{
